      ...
      <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-6xl flex-1 items-center justify-center">
        <section className="w-full max-w-[420px] border border-[#d8e1d4] bg-white p-8 shadow-[0_12px_30px_rgba(18,53,36,0.05)] md:p-10">
          <div>
            ...
            <h1 className="mt-3 text-2xl font-semibold tracking-[-0.04em] text-[#123524]">{title}</h1>
            <p className="mt-3 text-sm leading-6 text-[#506552]">{description}</p>
          </div>

          {children}

          {footer ? <div className="mt-6 text-sm text-[#506552]">{footer}</div> : null}
        </section>
      </div>
    </main>
  )
